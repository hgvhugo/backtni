...
public class CatalogoDocumentoDto {
    ...
    @NotBlank(message = "El nombre del documento no puede ser vacío"  , groups = {OnCreate.class, OnUpdate.class})
    @NotNull(message =  "El nombre del documento es requerido"  , groups = {OnCreate.class, OnUpdate.class})
    private String documento;

    @NotBlank(message = "El nombre no puede ser vacío"  , groups = {OnCreate.class, OnUpdate.class})
